namespace Chimera.SrcGen.SettingsUtil;

using System.Collections.Immutable;
using System.Linq;
using System.Text;

using Chimera.Analyzers;
...
");
		...
		(Compilation Compilation, ImmutableArray<TestType> ClassDeclarations) value)
	{
		...
		var consumerAttrSym = compilation.GetTypeByMetadataName("Chimera.Emulation.Common.CoreSettingsAttribute");
...
namespace Chimera.Emulation.Cores
{
