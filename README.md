...
Loading a core is an explicit act, exactly like loading a ROM - a file
...
never about *a particular console* - ROM-to-system routing, controller
...
edges found along the way - is in [design-principles.md](docs/design-principles.md).
...
Linux), and every native library is built twice - natively with gcc for
...
Pull requests are welcome - from people, from people working with AI
...
one firm requirement is legal cleanliness - you must have the right to submit
...
full pre-separation ancestry - including the BizHawk contributors' commit
history this work is built on - is preserved in
