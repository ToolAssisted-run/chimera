...
namespace Chimera.Tests.Client.Common.config
{
	...
	public sealed class SerializationStabilityTests
	{
		...
		private static readonly IReadOnlyDictionary<Type, string> KnownGoodFromChimera = new Dictionary<Type, string>
		{
			...
			[typeof(MovieConfig)] = $@"{{""MovieEndAction"":3,""EnableBackupMovies"":true,""MovieCompressionLevel"":2,""VBAStyleMovieLoadState"":false,""PlaySoundOnMovieEnd"":false,""DefaultTasStateManagerSettings"":{PAGED_SER_WITH_TYPE}}}",
