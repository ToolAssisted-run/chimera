...
#pragma warning disable CS0067 // Events are never used
		...
		public FileWriteResult SaveQuickSave(int slot, bool suppressOSD = false) => throw new NotImplementedException();
		public FileWriteResult SaveState(string path, string userFriendlyStateName, bool suppressOSD = false) => throw new NotImplementedException();
