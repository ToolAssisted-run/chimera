namespace Chimera.Client.EmuHawk
{
	partial class CheatEdit
	{
		...
		private void InitializeComponent()
		{
			...
			this.AddressHexIndLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.AddressBox = new Chimera.Client.EmuHawk.HexTextBox();
			this.ValueHexIndLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.ValueLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.CompareHexIndLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.CompareLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.DomainLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.DomainDropDown = new System.Windows.Forms.ComboBox();
			this.SizeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.SizeDropDown = new System.Windows.Forms.ComboBox();
			this.DisplayTypeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			...
			this.CompareBox = new Chimera.Client.EmuHawk.WatchValueBox();
			this.ValueBox = new Chimera.Client.EmuHawk.WatchValueBox();
			this.CompareTypeDropDown = new System.Windows.Forms.ComboBox();
			this.CompareTypeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.SuspendLayout();
			// 
			// NameBox
			// 
			...
			// CompareBox
			// 
			this.CompareBox.ByteSize = Chimera.Client.Common.WatchSize.Byte;
			...
			this.CompareBox.Type = Chimera.Client.Common.WatchDisplayType.Hex;
			this.CompareBox.TextChanged += new System.EventHandler(this.CompareBox_TextChanged);
			// 
			// ValueBox
			// 
			this.ValueBox.ByteSize = Chimera.Client.Common.WatchSize.Byte;
			...
			this.ValueBox.Type = Chimera.Client.Common.WatchDisplayType.Hex;
			// 
			// CompareTypeDropDown
			// 
		...
		private Chimera.WinForms.Controls.LocLabelEx AddressHexIndLabel;
		private HexTextBox AddressBox;
		private WatchValueBox ValueBox;
		private Chimera.WinForms.Controls.LocLabelEx ValueHexIndLabel;
		private Chimera.WinForms.Controls.LocLabelEx ValueLabel;
		private WatchValueBox CompareBox;
		private Chimera.WinForms.Controls.LocLabelEx CompareHexIndLabel;
		private Chimera.WinForms.Controls.LocLabelEx CompareLabel;
		private Chimera.WinForms.Controls.LocLabelEx DomainLabel;
		private System.Windows.Forms.ComboBox DomainDropDown;
		private Chimera.WinForms.Controls.LocLabelEx SizeLabel;
		private System.Windows.Forms.ComboBox SizeDropDown;
		private Chimera.WinForms.Controls.LocLabelEx DisplayTypeLabel;
		...
		private Chimera.WinForms.Controls.LocLabelEx CompareTypeLabel;
	}
}
