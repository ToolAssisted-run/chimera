...
using Chimera.Client.EmuHawk.ToolExtensions;
	...
	public partial class Cheats : ToolFormBase, IToolFormAutoConfig
	{
		...
		private void ToggleGameGenieButton()
		{
			GameGenieToolbarSeparator.Visible =
				...
				false; // cheat-code converters are core-specific and not part of Chimera
		}
		...
		{
			// cheat-code converters are core-specific and not part of Chimera
		}
