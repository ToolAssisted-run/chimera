...
namespace Chimera.Client.EmuHawk
{
	partial class Cheats
	{
		...
		private void InitializeComponent()
		{
			...
			this.CheatListView = new Chimera.Client.EmuHawk.InputRoll();
			this.CheatsContextMenu = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.ToggleContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RemoveContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.DisableAllContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ViewInHexEditorContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.CheatsMenu = new Chimera.WinForms.Controls.MenuStripEx();
			this.FileSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.NewMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.CheatsSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RemoveCheatMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.ToggleMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.DisableAllCheatsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.GameGenieSeparator = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.OpenGameGenieEncoderDecoderMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.OptionsSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.AlwaysLoadCheatsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.AutoSaveCheatsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.DisableCheatsOnLoadMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.GameGenieToolbarSeparator = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.LoadGameGenieToolbarItem = new System.Windows.Forms.ToolStripButton();
			this.TotalLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.MessageLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.CheatGroupBox = new System.Windows.Forms.GroupBox();
			this.CheatEditor = new Chimera.Client.EmuHawk.CheatEdit();
			...
			this.CheatListView.ColumnClick += new Chimera.Client.EmuHawk.InputRoll.ColumnClickEventHandler(this.CheatListView_ColumnClick);
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx NewMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx CheatsSubMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RemoveCheatMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx DisableAllCheatsMenuItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx GameGenieSeparator;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx OpenGameGenieEncoderDecoderMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx OptionsSubMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx AlwaysLoadCheatsMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx AutoSaveCheatsMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx DisableCheatsOnLoadMenuItem;
		...
		private Chimera.WinForms.Controls.LocLabelEx TotalLabel;
		private Chimera.WinForms.Controls.LocLabelEx MessageLabel;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ToggleMenuItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx GameGenieToolbarSeparator;
		private System.Windows.Forms.ContextMenuStrip CheatsContextMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ToggleContextMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RemoveContextMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx DisableAllContextMenuItem;
