...
namespace Chimera.Client.EmuHawk
{
	partial class GenericDebugger
	{
		...
		private void InitializeComponent()
		{
			...
			this.DebugSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.StepIntoMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.StepOverMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.StepOutMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator1 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.RefreshMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RegistersGroupBox = new System.Windows.Forms.GroupBox();
			this.RegisterPanel = new Chimera.Client.EmuHawk.RegisterBoxControl();
			this.BreakpointsGroupBox = new System.Windows.Forms.GroupBox();
			this.BreakPointControl1 = new Chimera.Client.EmuHawk.BreakpointControl();
			...
			this.DisassemblerView = new Chimera.Client.EmuHawk.InputRoll();
			this.DisassemblerContextMenu = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.AddBreakpointContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.SeekToBox = new Chimera.Client.EmuHawk.HexTextBox();
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx DebugSubMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx StepIntoMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx StepOverMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx StepOutMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RefreshMenuItem;
		private System.Windows.Forms.ContextMenuStrip DisassemblerContextMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx AddBreakpointContextMenuItem;
