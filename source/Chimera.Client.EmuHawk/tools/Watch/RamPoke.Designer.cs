namespace Chimera.Client.EmuHawk
{
    partial class RamPoke
    {
        ...
        private void InitializeComponent()
        {
			...
			this.OutputLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.ValeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.ValueBox = new Chimera.Client.EmuHawk.WatchValueBox();
			this.ValueHexLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.DisplayTypeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.SizeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.BigEndianLabel = new Chimera.WinForms.Controls.LocLabelEx();
        ...
        private Chimera.WinForms.Controls.LocLabelEx OutputLabel;
        private Chimera.WinForms.Controls.LocLabelEx ValeLabel;
        private WatchValueBox ValueBox;
		private Chimera.WinForms.Controls.LocLabelEx ValueHexLabel;
		private Chimera.WinForms.Controls.LocLabelEx DisplayTypeLabel;
		private Chimera.WinForms.Controls.LocLabelEx SizeLabel;
		private Chimera.WinForms.Controls.LocLabelEx BigEndianLabel;
