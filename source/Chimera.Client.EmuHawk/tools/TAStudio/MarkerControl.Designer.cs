namespace Chimera.Client.EmuHawk
{
	partial class MarkerControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.JumpToMarkerToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ScrollToMarkerToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.EditMarkerToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.EditMarkerFrameToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.AddMarkerToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator1 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.RemoveMarkerToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.MarkerView = new Chimera.Client.EmuHawk.InputRoll();
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ScrollToMarkerToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx EditMarkerToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx EditMarkerFrameToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx AddMarkerToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RemoveMarkerToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx JumpToMarkerToolStripMenuItem;
