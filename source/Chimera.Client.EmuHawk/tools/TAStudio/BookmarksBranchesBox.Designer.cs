namespace Chimera.Client.EmuHawk
{
	partial class BookmarksBranchesBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.BranchView = new Chimera.Client.EmuHawk.InputRoll();
			this.BranchesContextMenu = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.AddBranchContextMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.AddBranchWithTextContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.LoadBranchContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.UpdateBranchContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.UpdateWithTextToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.EditBranchTextContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.JumpToBranchContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.UndoBranchToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator2 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.RemoveBranchContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.BranchView.PointedCellChanged += new Chimera.Client.EmuHawk.InputRoll.CellChangeEventHandler(this.BranchView_PointedCellChanged);
			this.BranchView.SelectedIndexChanged += new System.EventHandler(this.BranchView_SelectedIndexChanged);
			this.BranchView.CellDropped += new Chimera.Client.EmuHawk.InputRoll.CellDroppedEvent(this.BranchView_CellDropped);
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx AddBranchContextMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RemoveBranchContextMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx LoadBranchContextMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx UpdateBranchContextMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx EditBranchTextContextMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx AddBranchWithTextContextMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx JumpToBranchContextMenuItem;
		private System.Windows.Forms.Button UndoBranchButton;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx UndoBranchToolStripMenuItem;
