...
namespace Chimera.Client.EmuHawk
{
	partial class TAStudio
	{
		...
		private void InitializeComponent()
		{
			...
			this.ForumThreadMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.TasPlaybackBox = new Chimera.Client.EmuHawk.PlaybackBox();
			this.MarkerControl = new Chimera.Client.EmuHawk.MarkerControl();
			...
			this.BookMarkControl = new Chimera.Client.EmuHawk.BookmarksBranchesBox();
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ForumThreadMenuItem;
