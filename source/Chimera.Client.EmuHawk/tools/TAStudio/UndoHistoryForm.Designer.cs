namespace Chimera.Client.EmuHawk
{
	partial class UndoHistoryForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.undoHereToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.redoHereToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.sepToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.clearHistoryToHereToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.HistoryView = new Chimera.Client.EmuHawk.InputRoll();
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx undoHereToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx redoHereToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx sepToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx clearHistoryToHereToolStripMenuItem;
