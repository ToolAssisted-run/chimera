namespace Chimera.Client.EmuHawk
{
	partial class FramesPrompt
	{
		...
		private void InitializeComponent()
		{
			...
			this.NumFramesBox = new Chimera.Client.EmuHawk.WatchValueBox();
			this.SuspendLayout();
			// 
			// OkBtn
			// 
			...
			// NumFramesBox
			// 
			this.NumFramesBox.ByteSize = Chimera.Client.Common.WatchSize.Word;
			...
			this.NumFramesBox.Type = Chimera.Client.Common.WatchDisplayType.Unsigned;
			// 
			// FramesPrompt
			// 
