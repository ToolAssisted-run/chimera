...
namespace Chimera.Client.EmuHawk
{
	partial class LuaConsole
	{
		...
		private void InitializeComponent()
		{
			...
			this.ToggleScriptContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.PauseScriptContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.EditScriptContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RemoveScriptContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.InsertSeperatorContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ScriptContextSeparator = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.StopAllScriptsContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ClearRegisteredFunctionsContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.menuStrip1 = new Chimera.WinForms.Controls.MenuStripEx();
			this.FileSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.NewSessionMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.OpenSessionMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.SaveSessionMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.SaveSessionAsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator9 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.RecentSessionsSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator8 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.RecentScriptsSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator3 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.ScriptSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.NewScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.OpenScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RefreshScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ToggleScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.PauseScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.EditScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RemoveScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.DuplicateScriptMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ClearConsoleMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.StopAllScriptsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RegisteredFunctionsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.SettingsSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.DisableScriptsOnLoadMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ReturnAllIfNoneSelectedMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ReloadWhenScriptFileChangesMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator4 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.RegisterToTextEditorsSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RegisterSublimeText2MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RegisterNotePadMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.HelpSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.FunctionsListMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.OnlineDocsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.OutputBox = new System.Windows.Forms.RichTextBox();
			this.ConsoleContextMenu = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.CopyContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.SelectAllContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ClearConsoleContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator5 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.RegisteredFunctionsContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ClearRegisteredFunctionsLogContextItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.groupBox1 = new System.Windows.Forms.GroupBox();
			this.InputBox = new System.Windows.Forms.TextBox();
			this.NumberOfScripts = new Chimera.WinForms.Controls.LocLabelEx();
			this.OutputMessages = new Chimera.WinForms.Controls.LocLabelEx();
			...
			this.LuaListView = new Chimera.Client.EmuHawk.InputRoll();
			...
			this.LuaListView.ColumnClick += new Chimera.Client.EmuHawk.InputRoll.ColumnClickEventHandler(this.LuaListView_ColumnClick);
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx SaveSessionMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx SaveSessionAsMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ScriptSubMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx EditScriptMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ToggleScriptMenuItem;
		private System.Windows.Forms.GroupBox groupBox1;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx NewSessionMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx SettingsSubMenu;
		private Chimera.WinForms.Controls.LocLabelEx NumberOfScripts;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx InsertSeparatorMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx StopAllScriptsMenuItem;
		private System.Windows.Forms.ContextMenuStrip ScriptListContextMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RecentScriptsSubMenu;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx toolStripSeparator3;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx StopAllScriptsContextItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RemoveScriptContextItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx InsertSeperatorContextItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx ScriptContextSeparator;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx EditScriptContextItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ToggleScriptContextItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RemoveScriptMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx OpenScriptMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx OpenSessionMenuItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx toolStripSeparator9;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RecentSessionsSubMenu;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx FunctionsListMenuItem;
		private System.Windows.Forms.ContextMenuStrip ConsoleContextMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ClearConsoleContextItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx DisableScriptsOnLoadMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx PauseScriptMenuItem;
		private System.Windows.Forms.ToolStripButton PauseToolbarItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx PauseScriptContextItem;
		public System.Windows.Forms.RichTextBox OutputBox;
		private Chimera.WinForms.Controls.LocLabelEx OutputMessages;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx OnlineDocsMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx NewScriptMenuItem;
		private System.Windows.Forms.ToolStripButton NewScriptToolbarItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RegisteredFunctionsMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RegisteredFunctionsContextItem;
		private System.Windows.Forms.ToolStripButton RefreshScriptToolbarItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RefreshScriptMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx DuplicateScriptMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ClearConsoleMenuItem;
		private System.Windows.Forms.TextBox InputBox;
		private System.Windows.Forms.SplitContainer splitContainer1;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ReturnAllIfNoneSelectedMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ReloadWhenScriptFileChangesMenuItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx toolStripSeparator4;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RegisterToTextEditorsSubMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RegisterSublimeText2MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RegisterNotePadMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx SelectAllContextItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx CopyContextItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ClearRegisteredFunctionsContextItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx toolStripSeparator5;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ClearRegisteredFunctionsLogContextItem;
	}
}