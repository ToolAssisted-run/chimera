namespace Chimera.Client.EmuHawk
{
	partial class MacroInputTool
	{
		...
		private void InitializeComponent()
		{
			...
			this.saveAsToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.loadMacroToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RecentToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx saveAsToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx loadMacroToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RecentToolStripMenuItem;
