namespace Chimera.Client.EmuHawk.CustomControls
{
	partial class MsgBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.messageLbl = new Chimera.WinForms.Controls.LocLabelEx();
		...
		private Chimera.WinForms.Controls.LocLabelEx messageLbl;
