namespace Chimera.Client.EmuHawk
{
	partial class HotkeyConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.MiscButton = new Chimera.Client.EmuHawk.MenuButton();
			this.clearBtnContextMenu = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.restoreDefaultsToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.clearAllToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.clearCurrentTabToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
        ...
        private Chimera.WinForms.Controls.LocLabelEx label1;
				...
				private Chimera.Client.EmuHawk.MenuButton MiscButton;
				private System.Windows.Forms.ContextMenuStrip clearBtnContextMenu;
				private Chimera.WinForms.Controls.ToolStripMenuItemEx clearAllToolStripMenuItem;
				private Chimera.WinForms.Controls.ToolStripMenuItemEx clearCurrentTabToolStripMenuItem;
				private Chimera.WinForms.Controls.ToolStripMenuItemEx restoreDefaultsToolStripMenuItem;
