namespace Chimera.Client.EmuHawk
{
	partial class AnalogBindControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelAxisName = new Chimera.WinForms.Controls.LocLabelEx();
			this.trackBarSensitivity = new System.Windows.Forms.TrackBar();
			this.labelSensitivity = new Chimera.WinForms.Controls.LocLabelEx();
			this.timer1 = new System.Windows.Forms.Timer(this.components);
			this.buttonBind = new System.Windows.Forms.Button();
			this.trackBarDeadzone = new System.Windows.Forms.TrackBar();
			this.labelDeadzone = new Chimera.WinForms.Controls.LocLabelEx();
			this.buttonFlip = new System.Windows.Forms.Button();
			this.buttonUnbind = new System.Windows.Forms.Button();
			this.iwPositiveButton = new Chimera.Client.EmuHawk.InputWidget();
			this.iwNegativeButton = new Chimera.Client.EmuHawk.InputWidget();
			this.labelPositiveButtonName = new Chimera.WinForms.Controls.LocLabelEx();
			this.labelNegativeButtonName = new Chimera.WinForms.Controls.LocLabelEx();
		...
		private Chimera.WinForms.Controls.LocLabelEx labelAxisName;
		private System.Windows.Forms.TrackBar trackBarSensitivity;
		private Chimera.WinForms.Controls.LocLabelEx labelSensitivity;
		private System.Windows.Forms.Timer timer1;
		private System.Windows.Forms.Button buttonBind;
		private System.Windows.Forms.TrackBar trackBarDeadzone;
		private Chimera.WinForms.Controls.LocLabelEx labelDeadzone;
