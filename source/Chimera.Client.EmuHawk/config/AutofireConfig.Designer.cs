namespace Chimera.Client.EmuHawk
{
	partial class AutofireConfig
	{
		...
		{
			this.btnDialogOK = new Chimera.WinForms.Controls.SzButtonEx();
			this.btnDialogCancel = new Chimera.WinForms.Controls.SzButtonEx();
			this.nudPatternOn = new Chimera.WinForms.Controls.SzNUDEx();
			this.nudPatternOff = new Chimera.WinForms.Controls.SzNUDEx();
			this.lblPatternOn = new Chimera.WinForms.Controls.LabelEx();
			this.lblPatternOff = new Chimera.WinForms.Controls.LabelEx();
			this.flpDialogButtons = new Chimera.WinForms.Controls.LocSzSingleRowFLP();
			this.flpDialog = new Chimera.WinForms.Controls.LocSzSingleColumnFLP();
			this.flpPattern = new Chimera.WinForms.Controls.SingleRowFLP();
			this.lblPatternDesc = new Chimera.WinForms.Controls.LabelEx();
			this.cbConsiderLag = new Chimera.WinForms.Controls.CheckBoxEx();
		...
		private Chimera.WinForms.Controls.SzButtonEx btnDialogOK;
		private Chimera.WinForms.Controls.SzButtonEx btnDialogCancel;
		private Chimera.WinForms.Controls.SzNUDEx nudPatternOff;
		private Chimera.WinForms.Controls.LabelEx lblPatternOn;
		private Chimera.WinForms.Controls.LabelEx lblPatternOff;
		private Chimera.WinForms.Controls.SingleRowFLP flpPattern;
		private Chimera.WinForms.Controls.LocSzSingleColumnFLP flpDialog;
		private Chimera.WinForms.Controls.LocSzSingleRowFLP flpDialogButtons;
		private Chimera.WinForms.Controls.LabelEx lblPatternDesc;
		public Chimera.WinForms.Controls.SzNUDEx nudPatternOn;
		private Chimera.WinForms.Controls.CheckBoxEx cbConsiderLag;
	}
}
