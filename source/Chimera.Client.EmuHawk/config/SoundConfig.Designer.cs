namespace Chimera.Client.EmuHawk
{
	partial class SoundConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.SoundDeviceLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.BufferSizeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.BufferSizeNumeric = new System.Windows.Forms.NumericUpDown();
			this.BufferSizeUnitsLabel = new Chimera.WinForms.Controls.LocLabelEx();
		...
		private Chimera.WinForms.Controls.LocLabelEx SoundDeviceLabel;
		private Chimera.WinForms.Controls.LocLabelEx BufferSizeLabel;
		private System.Windows.Forms.NumericUpDown BufferSizeNumeric;
		private Chimera.WinForms.Controls.LocLabelEx BufferSizeUnitsLabel;
