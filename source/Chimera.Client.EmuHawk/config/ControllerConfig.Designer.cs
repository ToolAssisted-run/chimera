namespace Chimera.Client.EmuHawk
{
	partial class ControllerConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.loadDefaultsToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.clearToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.btnMisc = new Chimera.Client.EmuHawk.MenuButton();
		...
		private MenuButton btnMisc;
				private Chimera.WinForms.Controls.ToolStripMenuItemEx loadDefaultsToolStripMenuItem;
				private Chimera.WinForms.Controls.ToolStripMenuItemEx clearToolStripMenuItem;
