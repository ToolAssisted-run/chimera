namespace Chimera.Client.EmuHawk
{
	partial class DisplayConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.label17 = new Chimera.WinForms.Controls.LocLabelEx();
			...
			this.label10 = new Chimera.WinForms.Controls.LocLabelEx();
			this.nudPrescale = new System.Windows.Forms.NumericUpDown();
			this.tpMisc = new System.Windows.Forms.TabPage();
			this.flpStaticWindowTitles = new Chimera.WinForms.Controls.LocSzSingleColumnFLP();
			this.cbStaticWindowTitles = new Chimera.WinForms.Controls.CheckBoxEx();
			this.lblStaticWindowTitles = new Chimera.WinForms.Controls.LocLabelEx();
			...
			this.lblFrameTypeWindowed = new Chimera.WinForms.Controls.LocLabelEx();
			this.cbStatusBarWindowed = new System.Windows.Forms.CheckBox();
			this.label9 = new Chimera.WinForms.Controls.LocLabelEx();
			this.cbMenuWindowed = new System.Windows.Forms.CheckBox();
			this.trackbarFrameSizeWindowed = new Chimera.Client.EmuHawk.TransparentTrackBar();
    ...
    "sing zapper, etc.)";
		...
		private Chimera.WinForms.Controls.LocLabelEx label9;
		private Chimera.Client.EmuHawk.TransparentTrackBar trackbarFrameSizeWindowed;
		...
		private Chimera.WinForms.Controls.LocLabelEx lblFrameTypeWindowed;
		private Chimera.WinForms.Controls.LocLabelEx label11;
		private Chimera.WinForms.Controls.LocLabelEx label10;
		...
		private Chimera.WinForms.Controls.LocLabelEx label17;
