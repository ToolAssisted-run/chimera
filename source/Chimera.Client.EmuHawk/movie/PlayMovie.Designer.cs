namespace Chimera.Client.EmuHawk
{
	partial class PlayMovie
	{
		...
		private void InitializeComponent()
		{
			...
			this.StopOnFrameTextBox = new Chimera.Client.EmuHawk.WatchValueBox();
			this.MovieCount = new Chimera.WinForms.Controls.LocLabelEx();
			this.editToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.StopOnFrameTextBox.ByteSize = Chimera.Client.Common.WatchSize.DWord;
			...
			this.StopOnFrameTextBox.Type = Chimera.Client.Common.WatchDisplayType.Unsigned;
		...
		private Chimera.WinForms.Controls.LocLabelEx MovieCount;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx editToolStripMenuItem;
