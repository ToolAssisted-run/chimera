...
namespace Chimera.Client.EmuHawk
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ScreenshotClipboardMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ScreenshotClientClipboardMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator20 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.ScreenshotCaptureOSDMenuItem1 = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator4 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.ExitMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.SystemSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.PauseMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.RebootCoreMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator1 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.EmulatorMenuSeparator2 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.LoadedCoreNameMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ViewSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.WindowSizeSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator26 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.DisableResizeWithFramebufferMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.SwitchToFullscreenMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.toolStripMenuItem4 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.DisplayStatusBarMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.DisplayMessagesMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator8 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.DisplayLogWindowMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ConfigSubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ControllersMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.HotkeysMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.ClockThrottleMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.AudioThrottleMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.VsyncThrottleMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator27 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.VsyncEnabledMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripMenuItem3 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.miUnthrottled = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.MinimizeSkippingMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.NeverSkipMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripMenuItem17 = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip1MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip2MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip3MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip4MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip5MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip6MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip7MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip8MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Frameskip9MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripMenuItem5 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.Speed50MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Speed75MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Speed100MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Speed150MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Speed200MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.Speed400MenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.KeyPrioritySubMenu = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.BothHkAndControllerMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.InputOverHkMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.HkOverInputMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator10 = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.SaveConfigMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.SaveConfigAsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.ForumsMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.FeaturesMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.UpdateNotification = new Chimera.WinForms.Controls.StatusLabelEx();
			...
			this.AddSubtitleContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ViewCommentsContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.toolStripMenuItem7 = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripMenuItem8 = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripMenuItem9 = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.CloseRomContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.ShowMenuContextMenuSeparator = new Chimera.WinForms.Controls.ToolStripSeparatorEx();
			this.ShowMenuContextMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RamWatchMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx RamSearchMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx HexEditorMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx WindowSizeSubMenu;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx toolStripSeparator2;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx DisplayFPSMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx VsyncThrottleMenuItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx toolStripMenuItem3;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx MinimizeSkippingMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx NeverSkipMenuItem;
		private Chimera.WinForms.Controls.ToolStripSeparatorEx toolStripMenuItem5;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Speed50MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Speed75MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Speed100MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Speed150MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Speed200MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ClockThrottleMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx ForumsMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx VsyncEnabledMenuItem;
		private Chimera.WinForms.Controls.StatusLabelEx LedLightStatusLabel;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx KeyPrioritySubMenu;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx BothHkAndControllerMenuItem;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx toolStripMenuItem8;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx toolStripMenuItem9;
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx FeaturesMenuItem;
		private Chimera.WinForms.Controls.StatusLabelEx UpdateNotification;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx MacroToolMenuItem;
		private System.Windows.Forms.Timer timerMouseIdle;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx miUnthrottled;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx toolStripMenuItem17;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip1MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip2MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip3MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip4MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip5MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip6MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip7MenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx Frameskip9MenuItem;
