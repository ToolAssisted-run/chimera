...
namespace Chimera.Tests.Client.Common.config
{
	...
	public sealed class SerializationStabilityTests
	{
		...
		private const string PAGED_SER_BASE = @"""AutoMemoryLimit"":true,""OldStatesOnDisk"":true,""TotalMemoryLimitMB"":1024,""FramesBetweenNewStates"":4,""FramesBetweenMidStates"":20,""FramesBetweenOldStates"":400,""NewToMidRatio"":2.0,""FramesBetweenSavedStates"":100,""ForceSaveMarkerStates"":false}";
		...
		public void AssertAllTypesKnownSerializable()
		{
			static void CheckMemberAndTypeParams(Type t, string groupDesc)
			{
				...
				Assert.IsTrue(KnownGoodFromStdlib.Contains(t) || KnownGoodFromChimera.ContainsKey(t), $"type {t.FullName}, present in {groupDesc}, may not be serializable");
			}
		...
		public void TestRoundTripSerialization()
		{
			...
			foreach (var (type, s) in KnownGoodFromChimera)
			{
				if (s == "TODO") continue;
