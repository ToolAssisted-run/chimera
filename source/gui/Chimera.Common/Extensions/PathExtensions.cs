...
namespace Chimera.Common.PathExtensions
{
...
#pragma warning restore RS0030
	...
	{
		/// <returns>absolute path of the user data dir <c>$CHIMERA_DATA_HOME</c>, or fallback value equal to <see cref="ExeDirectoryPath"/></returns>
		/// <remarks>
		/// returned string omits trailing slash<br/>
