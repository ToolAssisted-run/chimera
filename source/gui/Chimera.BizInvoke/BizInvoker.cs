...
namespace Chimera.BizInvoke
{
	public static class BizInvoker
	{
		...
		/// <exception cref="InvalidOperationException"><see cref="GetInvoker{T}(Chimera.Common.IImportResolver,Chimera.Common.IMonitor,Chimera.BizInvoke.ICallingConventionAdapter)"/> overload previously called with <paramref name="dll"/></exception>
