...
{
	public static class NativeInvokeUtilities
	{
		/// <summary>
...
#pragma warning restore RCS1130
		...
		private static CustomAttributeBuilder GetAttributeBuilder(object o)
		{
			...
			throw new InvalidOperationException($"parameter of a NativeInvoke method had unknown attribute {o.GetType().FullName}");
		}
	}
}
