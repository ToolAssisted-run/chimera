...
namespace Chimera.Client.GUI
{
	partial class RamSearch
	{
		...
		private void InitializeComponent()
		{
			...
			this.WatchListView = new Chimera.Client.GUI.InputRoll();
			...
			this.DifferenceBox = new Chimera.Client.GUI.WatchValueBox();
			this.DifferenceRadio = new System.Windows.Forms.RadioButton();
			this.NumberOfChangesBox = new Chimera.Client.GUI.UnsignedIntegerBox();
			this.SpecificAddressBox = new Chimera.Client.GUI.HexTextBox();
			this.SpecificValueBox = new Chimera.Client.GUI.WatchValueBox();
			...
			this.DifferentByBox = new Chimera.Client.GUI.WatchValueBox();
			...
			this.WatchListView.ColumnClick += new Chimera.Client.GUI.InputRoll.ColumnClickEventHandler(this.WatchListView_ColumnClick);
