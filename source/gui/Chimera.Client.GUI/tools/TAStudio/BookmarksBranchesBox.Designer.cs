namespace Chimera.Client.GUI
{
	partial class BookmarksBranchesBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.BranchView = new Chimera.Client.GUI.InputRoll();
			...
			this.BranchView.PointedCellChanged += new Chimera.Client.GUI.InputRoll.CellChangeEventHandler(this.BranchView_PointedCellChanged);
			this.BranchView.SelectedIndexChanged += new System.EventHandler(this.BranchView_SelectedIndexChanged);
			this.BranchView.CellDropped += new Chimera.Client.GUI.InputRoll.CellDroppedEvent(this.BranchView_CellDropped);
