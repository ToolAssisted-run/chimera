namespace Chimera.Client.GUI
{
	partial class GuiOptions
	{
		...
		private void InitializeComponent()
		{
			...
			this.locLabelEx1 = new Chimera.WinForms.Controls.LocLabelEx();
			...
			this.NeverAskSaveCheckbox.Text = "When Chimera is closing, skip \"unsaved changes\" prompts and discard all.";
			...
			this.label14.Text = "Note: Requires closing and reopening Chimera to take effect.";
			// 
			...
			this.label3.Text = "Enable to force only one instance of Chimera at a time.";
			// 
