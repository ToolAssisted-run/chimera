...
{
	/// <summary>Used by <see cref="IChimeraArchiveFile"/> to represent archive members.</summary>
	public readonly struct ChimeraArchiveFileItem
	{
		...
		public ChimeraArchiveFileItem(string name, long size, int index, int archiveIndex)
		{
			Name = name;
			Size = size;
			Index = index;
