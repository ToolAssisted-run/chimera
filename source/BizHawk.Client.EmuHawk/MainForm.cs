...
namespace BizHawk.Client.EmuHawk
{
		...
		IMainFormForApi, IMainFormForTools
	{
		...
		private readonly ToolStripMenuItemEx NullHawkVSysSubmenu = new() { Enabled = false, Text = "â€”" };
		...
		private void MainForm_Load(object sender, EventArgs e)
		{
			...
			ToolStripMenuItemEx superHawkThrottleMenuItem = new() { Text = "SUPERÂ·HAWK" };
...
//				Util.DebugWriteLine($"  Selecting display size {lastComputedSize}");
		...
		public static readonly FilesystemFilterSet CorePackageFSFilterSet = new(
			new FilesystemFilter("miniHawk Core Package", extensions: [ "zip" ]));
