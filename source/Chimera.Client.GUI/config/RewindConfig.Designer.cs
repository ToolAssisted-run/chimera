namespace Chimera.Client.GUI
{
	partial class RewindConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.label4 = new Chimera.WinForms.Controls.LabelEx();
			...
			this.StateSizeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.label6 = new Chimera.WinForms.Controls.LocLabelEx();
			this.FullnessLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.groupBox4 = new System.Windows.Forms.GroupBox();
			this.locSingleRowFLP1 = new Chimera.WinForms.Controls.LocSingleRowFLP();
			this.labelEx3 = new Chimera.WinForms.Controls.LabelEx();
			this.labelEx2 = new Chimera.WinForms.Controls.LabelEx();
			this.labelEx1 = new Chimera.WinForms.Controls.LabelEx();
			...
			this.EstTimeLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.label11 = new Chimera.WinForms.Controls.LocLabelEx();
			this.ApproxFramesLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.label8 = new Chimera.WinForms.Controls.LocLabelEx();
			this.RewindFramesUsedLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.label7 = new Chimera.WinForms.Controls.LocLabelEx();
			...
			this.label20 = new Chimera.WinForms.Controls.LocLabelEx();
			this.KbLabel = new Chimera.WinForms.Controls.LocLabelEx();
			...
			this.label13 = new Chimera.WinForms.Controls.LocLabelEx();
			this.label14 = new Chimera.WinForms.Controls.LocLabelEx();
			this.ScreenshotInStatesCheckbox = new System.Windows.Forms.CheckBox();
			this.label15 = new Chimera.WinForms.Controls.LocLabelEx();
			this.label16 = new Chimera.WinForms.Controls.LocLabelEx();
			this.BackupSavestatesCheckbox = new System.Windows.Forms.CheckBox();
			this.label12 = new Chimera.WinForms.Controls.LocLabelEx();
		...
		private Chimera.WinForms.Controls.LocLabelEx StateSizeLabel;
		private Chimera.WinForms.Controls.LabelEx label4;
		...
		private Chimera.WinForms.Controls.LocLabelEx FullnessLabel;
		private System.Windows.Forms.GroupBox groupBox4;
		private Chimera.WinForms.Controls.LocLabelEx RewindFramesUsedLabel;
		private Chimera.WinForms.Controls.LocLabelEx label7;
		private Chimera.WinForms.Controls.LocLabelEx ApproxFramesLabel;
		private Chimera.WinForms.Controls.LocLabelEx label8;
		private Chimera.WinForms.Controls.LocLabelEx EstTimeLabel;
		private Chimera.WinForms.Controls.LocLabelEx label11;
		...
		private Chimera.WinForms.Controls.LocLabelEx label12;
		private Chimera.WinForms.Controls.LocLabelEx KbLabel;
		...
		private Chimera.WinForms.Controls.LocLabelEx label13;
		private Chimera.WinForms.Controls.LocLabelEx label14;
		private System.Windows.Forms.CheckBox ScreenshotInStatesCheckbox;
		private Chimera.WinForms.Controls.LocLabelEx label15;
		private Chimera.WinForms.Controls.LocLabelEx label16;
		private System.Windows.Forms.CheckBox BackupSavestatesCheckbox;
		private Chimera.WinForms.Controls.LocLabelEx label20;
