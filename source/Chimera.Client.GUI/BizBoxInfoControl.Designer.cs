namespace Chimera.Client.GUI
{
	partial class BizBoxInfoControl
	{
		...
		{
			this.CoreNameLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.CoreAuthorLabel = new Chimera.WinForms.Controls.LocLabelEx();
			this.CorePortedLabel = new Chimera.WinForms.Controls.LocLabelEx();
		...
		private Chimera.WinForms.Controls.LocLabelEx CoreNameLabel;
		private Chimera.WinForms.Controls.LocLabelEx CoreAuthorLabel;
		private Chimera.WinForms.Controls.LocLabelEx CorePortedLabel;
