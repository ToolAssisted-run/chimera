...
namespace Chimera.Client.GUI
{
	public sealed class FFmpegDownloaderForm : DownloaderForm
	{
		...
		{
			Description = "Chimera relies on a specific version of FFmpeg. No other version will do. The wrong version will be ignored. There is no way to override this behavior."
		...
		protected override Stream GetExtractionStream(ChimeraFile downloaded)
			=> (OSTailoredCode.IsUnixHost
