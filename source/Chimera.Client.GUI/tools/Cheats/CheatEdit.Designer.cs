namespace Chimera.Client.GUI
{
	partial class CheatEdit
	{
		...
		private void InitializeComponent()
		{
			...
			this.AddressBox = new Chimera.Client.GUI.HexTextBox();
			...
			this.CompareBox = new Chimera.Client.GUI.WatchValueBox();
			this.ValueBox = new Chimera.Client.GUI.WatchValueBox();
