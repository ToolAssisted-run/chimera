...
namespace Chimera.Client.GUI
{
	partial class Cheats
	{
		...
		private void InitializeComponent()
		{
			...
			this.CheatListView = new Chimera.Client.GUI.InputRoll();
			...
			this.CheatEditor = new Chimera.Client.GUI.CheatEdit();
			...
			this.CheatListView.ColumnClick += new Chimera.Client.GUI.InputRoll.ColumnClickEventHandler(this.CheatListView_ColumnClick);
