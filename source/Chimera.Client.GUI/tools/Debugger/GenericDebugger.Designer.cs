...
namespace Chimera.Client.GUI
{
	partial class GenericDebugger
	{
		...
		private void InitializeComponent()
		{
			...
			this.RegisterPanel = new Chimera.Client.GUI.RegisterBoxControl();
			this.BreakpointsGroupBox = new System.Windows.Forms.GroupBox();
			this.BreakPointControl1 = new Chimera.Client.GUI.BreakpointControl();
			...
			this.DisassemblerView = new Chimera.Client.GUI.InputRoll();
			...
			this.SeekToBox = new Chimera.Client.GUI.HexTextBox();
