...
namespace Chimera.Client.GUI
{
	partial class LuaConsole
	{
		...
		private void InitializeComponent()
		{
			...
			this.LuaListView = new Chimera.Client.GUI.InputRoll();
			...
			this.LuaListView.ColumnClick += new Chimera.Client.GUI.InputRoll.ColumnClickEventHandler(this.LuaListView_ColumnClick);
