namespace Chimera.Client.GUI
{
	partial class LuaRegisteredFunctionsList
	{
		...
		private void InitializeComponent()
		{
			...
			this.callToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
			this.removeToolStripMenuItem = new Chimera.WinForms.Controls.ToolStripMenuItemEx();
		...
		private Chimera.WinForms.Controls.ToolStripMenuItemEx callToolStripMenuItem;
		private Chimera.WinForms.Controls.ToolStripMenuItemEx removeToolStripMenuItem;
