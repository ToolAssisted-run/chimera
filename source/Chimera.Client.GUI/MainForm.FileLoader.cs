...
namespace Chimera.Client.GUI
{
	public partial class MainForm
	{
		...
		private void FormDragDrop_internal()
		{
			...
			ProcessFileList(PathsFromDragDrop.Select(GuiUtil.ResolveShortcut), ref sortedFiles);
					...
					case 1:
						...
						switch (value)
						{
							...
							case LoadOrdering.MovieFile:
								...
								if (sortedFiles[LoadOrdering.MovieFile].Count > 1)
									break;

								_ = LoadMovie(filename, fileInformation.ArchiveName);
								break;
						}
						break;
				}
